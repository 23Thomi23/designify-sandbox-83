      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Transformamos propiedades ordinarias en espacios extraordinarios a través de imágenes de alta calidad.
          </p>
        </motion.div>
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="h-64 overflow-hidden">
                <img 
                  src={`${project.image}?q=80&w=1200&auto=format&fit=crop`} 
                  alt={project.title} 
